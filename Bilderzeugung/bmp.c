...
int bm_putc(Bitmap *b, int x, int y, unsigned char c) {
    unsigned char text[2] = {c, 0};
    assert(b);
	return bm_puts(b, x, y, text);
}

int bm_puts(Bitmap *b, int x, int y, const unsigned char *text) {
    assert(b);
...
static int rf_puts(Bitmap *b, int x, int y, const unsigned char *s) {
...
static int sf_puts(Bitmap *b, int x, int y, const unsigned char *s) {
...
static int xbmf_puts(Bitmap *b, int x, int y, const unsigned char *text) {
    XbmFontInfo *info;
    int xs = x, spacing;
    const unsigned char *bits;
